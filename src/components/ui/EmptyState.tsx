    ...
    >
      <defs>
        <linearGradient id="empty-gradient" x1="0" y1="0" x2="200" y2="160">
          <stop offset="0%" stopColor="#CD1719" stopOpacity="0.15" />
      ...
      <rect
        ...
        strokeDasharray="6 4"
      />
      <circle cx="100" cy="65" r="18" fill="#CD1719" fillOpacity="0.12" />
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="50" y="95" width="100" height="8" rx="4" fill="#CD1719" fillOpacity="0.1" />
      <rect x="65" y="110" width="70" height="6" rx="3" fill="#CD1719" fillOpacity="0.08" />
      <motion.circle
        cx="165"
        cy="45"
        r="4"
